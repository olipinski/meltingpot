...
from meltingpot.configs.substrates import (
    bach_or_stravinsky_in_the_matrix__repeated as bach_or_stravinsky_itm__repeated,
)
from meltingpot.configs.substrates import chicken_in_the_matrix__arena as chicken_itm
from meltingpot.configs.substrates import (
    chicken_in_the_matrix__repeated as chicken_itm__repeated,
)
from meltingpot.configs.substrates import (
    prisoners_dilemma_in_the_matrix__arena as prisoners_dilemma_itm,
)
from meltingpot.configs.substrates import (
    prisoners_dilemma_in_the_matrix__repeated as prisoners_dilemma_itm__repeated,
)
from meltingpot.configs.substrates import (
    pure_coordination_in_the_matrix__arena as pure_coord_itm,
)
from meltingpot.configs.substrates import (
    pure_coordination_in_the_matrix__repeated as pure_coord_itm__repeated,
)
from meltingpot.configs.substrates import (
    rationalizable_coordination_in_the_matrix__arena as rational_coord_itm,
)
from meltingpot.configs.substrates import (
    rationalizable_coordination_in_the_matrix__repeated as rational_coord_itm__repeated,
)
from meltingpot.configs.substrates import (
    running_with_scissors_in_the_matrix__arena as rws_itm__arena,
)
from meltingpot.configs.substrates import (
    running_with_scissors_in_the_matrix__one_shot as rws_itm,
)
from meltingpot.configs.substrates import (
    running_with_scissors_in_the_matrix__repeated as rws_itm__repeated,
)
from meltingpot.configs.substrates import (
    stag_hunt_in_the_matrix__arena as stag_hunt_itm,
)
from meltingpot.configs.substrates import (
    stag_hunt_in_the_matrix__repeated as stag_hunt_itm__repeated,
)
from meltingpot.human_players import level_playing_utils

environment_configs = {
    "bach_or_stravinsky_in_the_matrix__arena": bach_or_stravinsky_itm,
    "bach_or_stravinsky_in_the_matrix__repeated": bach_or_stravinsky_itm__repeated,
    ...
    "prisoners_dilemma_in_the_matrix__repeated": prisoners_dilemma_itm__repeated,
    ...
    "rationalizable_coordination_in_the_matrix__repeated": rational_coord_itm__repeated,
...
def verbose_fn(env_timestep, player_index, current_player_index):
    ...
    collected_resource_1 = env_timestep.observation[f"{lua_index}.COLLECTED_RESOURCE_1"]
    collected_resource_2 = env_timestep.observation[f"{lua_index}.COLLECTED_RESOURCE_2"]
    destroyed_resource_1 = env_timestep.observation[f"{lua_index}.DESTROYED_RESOURCE_1"]
    destroyed_resource_2 = env_timestep.observation[f"{lua_index}.DESTROYED_RESOURCE_2"]
    interacted_this_step = env_timestep.observation[f"{lua_index}.INTERACTED_THIS_STEP"]
