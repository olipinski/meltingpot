...
class PlayLevelTest(parameterized.TestCase):
    @parameterized.named_parameters(
        ...
        ("commons_harvest__closed", commons_harvest__closed, play_commons_harvest),
        ...
        ("paintball__capture_the_flag", paintball__capture_the_flag, play_paintball),
        ("paintball__king_of_the_hill", paintball__king_of_the_hill, play_paintball),
        (
            "predator_prey__alley_hunt",
            predator_prey__alley_hunt,
            play_predator_and_prey,
        ),
        ("predator_prey__orchard", predator_prey__orchard, play_predator_and_prey),
        (
