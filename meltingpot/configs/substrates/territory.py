...
def get_dry_painted_wall_palette(
    base_color: shapes.Color,
...
def get_brush_palette(base_color: shapes.Color) -> Mapping[str, shapes.ColorRGBA]:
    return {
        "*": base_color + (255,),
        ...
        "components": [
            ...
            },
            {
                ...
                "kwargs": {
                    "renderMode": "ascii_shape",
                    "spriteNames": [
                        "UnclaimedResourceSprite",
                    ],
                    "spriteShapes": [shapes.WALL],
                    "palettes": [{"*": (61, 61, 61, 255), "#": (80, 80, 80, 255)}],
                    "noRotates": [True],
                },
            },
            {
        ...
        "components": [
            {
                ...
                "kwargs": {
                    "initialState": "inactive",
                    "stateConfigs": [
                        {"state": "inactive", "layer": "superDirectionIndicatorLayer"},
                        {
                            "state": "damaged",
        ...
        "components": [
            ...
            },
            {
                ...
                "kwargs": {
                    ...
                    "palettes": [get_marking_palette(0.0), get_marking_palette(1.0)],
                    "noRotates": [True] * 3,
                },
            },
            {
