...
def dissipate_when_paired(g: nx.MultiDiGraph, reaction_name: str, compound: str):
...
def build(
    ...
    avatar_objects, additional_objects = create_avatar_objects(num_players, compounds)
