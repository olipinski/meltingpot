    ...
    "components": [
        ...
        {"component": "Transform"},
        {
            ...
            "kwargs": {
                ...
                "spriteShapes": [shapes.HOPPER_BODY, shapes.HOPPER_BODY_ACTIVATED],
                "palettes": [
                    {
                        "a": (140, 129, 129, 255),
                        "b": (84, 77, 77, 255),
...
def _create_stamina_overlay(
    ...
    for i in range(max_stamina_bar_states):
        ...
        stamina_bar_state_configs.append(
            {"state": f"level_{i}", "layer": stamina_bar_layer, "sprite": sprite_name}
        )
...
def create_avatar_object(
    player_idx: int, target_sprite_self: Dict[str, Any], max_stamina_bar_states: int
) -> Dict[str, Any]:
        ...
        "components": [
            ...
            },
            {
                ...
                "kwargs": {
                    ...
                    "additionalLiveStates": [grappled_state_name, grappling_state_name],
